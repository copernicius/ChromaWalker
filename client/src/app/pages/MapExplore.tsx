...
import { MapPin, Navigation as NavigationIcon, Locate, TrendingUp } from 'lucide-react';
      ...
      <div className="max-w-screen-xl mx-auto pt-16 px-4">
        ...
        <div className="mb-6">
          <h1 className="text-3xl font-bold text-[#2D2520] mb-2">
            <span className="italic" style={{ fontFamily: 'var(--font-brand-serif)' }}>Explore</span> Map
          </h1>
