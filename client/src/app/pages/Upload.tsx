...
import { Upload as UploadIcon, MapPin, Check, Camera } from 'lucide-react';
      ...
      <div className="max-w-screen-xl mx-auto px-4 pt-16">
        ...
        <div className="mb-6">
          <h1 className="text-3xl font-bold text-[#2D2520] mb-2">
            Upload <span className="italic" style={{ fontFamily: 'var(--font-brand-serif)' }}>Photo</span>
          </h1>
        ...
        <div className="bg-white rounded-3xl p-6 shadow-sm mb-6">
          ...
          {/* Color Selection */}
          <div className="mb-4">
            <label className="block text-sm font-semibold mb-3 text-[#2D2520]">Select Color</label>
            ...
            {selectedColor && (
              <p className="text-sm text-gray-600 mt-2">
                Selected: <span className="font-semibold text-[#2D2520]">
          ...
          {/* Location Input */}
          <div className="mb-6">
            <label className="block text-sm font-semibold mb-3 text-[#2D2520]">Location</label>
            ...
            <button className="mt-2 text-sm text-[#C89F7B] font-medium hover:text-[#B08968] transition-colors">
